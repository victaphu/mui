...
import NftDropCardComponent from '../nft/nftDropCard'
import useWindow from '../../hooks/useWindow'
import { collectionSorting } from '../../constants/filter'

export default function TradeClosingSoon() {
  const { setOrder, setFilter, dataListLoading, dataListOrder, dataListData, dataListMessage } =
    useDataListApi(
      '/nfts',
      { per_page: 9, order_by: 'on_sale_end_time', order_dir: 'asc', sales_only: true },
      [],
      collectionSorting
    )
  ...
  return (
    <div className="relative w-full">
      ...
      <DataList
        ...
        listRender={(item) => <NftDropCardComponent key={item.id} nft={item} />}
